...
const CustomerReviews = () => {
    ...
    return (
        <div className="container mx-auto px-10 lg:px-0">
            <CarouselTestimonial></CarouselTestimonial>
        </div>
    );
};
                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-relaxed">
                                                <p>
                                                    As someone with a keen eye for detail and quality, I was pleasantly surprised by the exceptional craftsmanship and attention to detail in every piece I purchased.
                                                </p>
                                            </blockquote>
                                ...
                                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-relaxed">
                                                <p>
                                                    Being a fitness instructor, I live in activewear, and Si'an Boutique's selection is top-notch! The quality is exceptional, and the styles are on point.
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                                <div className="rating rating-sm">
                                ...
                                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-relaxed">
                                                <p>
                                                    As a fashion enthusiast, I'm always on the lookout for unique pieces that make a statement. Si'an Boutique exceeded my expectations with their curated selection of trendy yet timeless pieces.
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                                <div className="rating rating-sm">
